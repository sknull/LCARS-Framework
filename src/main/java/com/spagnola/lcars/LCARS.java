...
public class LCARS {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(LCARS.class);
     ...
     */
    private static final String LCARS_FONT_FILENAME = "swz911uc.ttf";
    ...
    public void loadLCARSFont() {
        try {
             ...
             */
            LCARSFont = Font.createFont(Font.TRUETYPE_FONT, new File(ClassLoader.getSystemResource(LCARS_FONT_FILENAME).toURI()));
    ...
    public static String getIPAddress() {
        if (LCARS.ipAddress == null) {
            ...
            try {
                ...
                LOGGER.warn(uhe.getMessage() + " - Couldn't find IP address, returning local loop back address.");
            } catch (SocketException se) {
                LOGGER.warn(se.getMessage() + " - Socket exception while trying to get network interfaces.");
            }
        }
